...
6. We have provided a script to automate the conversion from Caffe model to *.txn register control sequences and also memory traces. Go to section "Automated Script for xx" for details.
